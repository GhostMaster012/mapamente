...
$("#templateEthicsResearchBtn")?.addEventListener("click", loadEthicsResearchTrifold);
$("#templateEthicsClassBtn")?.addEventListener("click", loadEthicsClassTrifold);
$("#templateEthicsCompleteBtn")?.addEventListener("click", loadEthicsCompleteTrifold);
...
$("#elemWidthDown")?.addEventListener("click", () => changeActiveElementWidth(-20));
$("#elemWidthUp")?.addEventListener("click", () => changeActiveElementWidth(20));
$("#elemHeightDown")?.addEventListener("click", () => changeActiveElementHeight(-15));
$("#elemHeightUp")?.addEventListener("click", () => changeActiveElementHeight(15));
